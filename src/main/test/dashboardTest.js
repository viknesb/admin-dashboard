	...
	describe('ProjectCtrl', function(){
      it('should be defined',
	    inject(function($rootScope, $controller, $httpBackend) {
          var scope = $rootScope.$new();
		  $httpBackend.when('GET', 'projectregistry/get/projects').respond({"workspaceProjects":[{"projectName":"default","gateway":{"gatewayName":"default"},"airavataUser":{"userName":"blah user"}}]});
